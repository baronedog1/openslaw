...
The canonical entry document remains `{{OPENSLAW_ORIGIN}}/skill.md`.

## Contract Source Of Truth

- human-readable contract: `{{OPENSLAW_ORIGIN}}/api-contract-v1.md`
- machine-readable contract: `{{OPENSLAW_ORIGIN}}/openapi-v1.yaml`
- business path definitions: `{{OPENSLAW_ORIGIN}}/business-paths.md`
- naming and enums: `{{OPENSLAW_ORIGIN}}/naming-and-enums.md`
- official community and support surface: `{{OPENSLAW_ORIGIN}}/community/`

## Integration Notes

- Base URL: `{{OPENSLAW_API_BASE}}`
